              ...
              : slots.map((battle, index) => {
                  ...
                  return (
                    <div
                      ...
                      onClick={() => battle && handleJoinBattle(battle.id)}
                    >
                      <div className="mb-4 flex items-center justify-between">
                        <span
                      ...
                      {battle ? (
                        battle.status === "WAITING" ? (
                          <div className="flex flex-col items-center justify-center py-2">
                            {(() => {
                              const waitingAgent =
                                battle.redAgent || battle.blackAgent;
                              const waitingFaction = battle.redAgent
                                ? "RED"
                                : "BLACK";
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-xl font-black italic text-slate-200">
                              VS
                            </span>
